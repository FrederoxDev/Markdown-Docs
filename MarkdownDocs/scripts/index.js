...
const { getCurrentProject, getCurrentRP } = await require("@bridge/env")
...
class MarkdownSidebar extends SidebarContent {
    ...
    async ParseFile(fileName) {
        ...
        var file = await (await fileHandle.getFile()).text()
    ...
    async SaveOutput() {
        ...
        await writeJSON(getCurrentRP() + "/ui/how_to_play_screen.json", output, true)
    }
}
